...
여기서는[US East (N. Virginia) - us-east-1을 사용합니다. [Model access](https://us-east-1.console.aws.amazon.com/bedrock/home?region=us-east-1#/modelaccess)에 접속해서 [Edit]를 선택하여 모든 모델을 사용할 수 있도록 설정합니다. 특히 "Titan Embeddings G1 - Text"은 OpenSearch와 연결되어 Vector Embedding을 위해서 반드시 사용이 가능하여야 합니다.
